...
function my_display_shortcode_accordion($atts,$content) {
	...
	$output = '<div class="accordion-group">';
		$output .= '<div class="accordion-heading">';
			$output .= '<a class="accordion-toggle '.$activeClass.'" data-toggle="collapse" data-parent="#id-'.$my_global_var.'" href="#'.$toggleid.'"><i style="padding-right:10px" class="icon-angle-right"></i> '.$title.'</a>';
		$output .= '</div>';
