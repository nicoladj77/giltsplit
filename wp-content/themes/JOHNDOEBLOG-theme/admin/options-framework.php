...
function optionsframework_rolescheck () {
	if ( current_user_can( 'edit_theme_options' ) ) {
		...
		add_action( 'admin_init', 'hs_optionsframework_init' );
...
function optionsframework_add_page() {
	...
	$of_page = add_menu_page('Theme Options', 'Theme Options', 'edit_theme_options', 'options-framework', 'optionsframework_page', OPTIONS_FRAMEWORK_DIRECTORY.'images/options-settings16.png', 61);
...
if ( !function_exists( 'optionsframework_add_subpage1' ) ) {
	function optionsframework_add_subpage1 () {
		$of_page = add_submenu_page('options-framework', 'hercules Templates', 'hercules Templates', 'administrator', 'options-framework-tmpls',  'admin_screen_tmpls');		
	}
}

if ( !function_exists( 'optionsframework_add_subpage2' ) ) {
	function optionsframework_add_subpage2 () {
		$of_page = add_submenu_page('options-framework', 'Customize', 'Customize', 'administrator', 'customize.php');		
	}
}
...
?>
	<div id="optionsframework-wrap" class="wrap">
		...
		<div>
			<h1><?php hs_site_title(); ?></h1>
			<p>Administration Panel</p>
		</div>
		<div class="clear"></div>
		<div style="float:left; width:200px; background:#86badf; margin-top:12px; margin-right:12px; ">
...
if ( ! function_exists( 'admin_screen_tmpls' ) ) {
	function admin_screen_tmpls () { ?>
		<div class="wrap">
			<p><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/admin/images/hercules-bnr.png" alt=""></a></p>
		</div><!--/.wrap-->
	<?php	
	}
}