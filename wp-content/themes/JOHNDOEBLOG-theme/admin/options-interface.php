...
function optionsframework_tabs() {
	...
	foreach ($hs_options as $value) {
		// Heading for Navigation
		if ($value['type'] == "heading") {
			$jquery_click_hook = preg_replace('/[^a-zA-Z0-9._\-]/', '', strtolower($value['name']) );
			$jquery_click_hook = "of-option-" . $jquery_click_hook;
			$hs_menu .= '<li><a id="'.  esc_attr( $jquery_click_hook ) . '-tab" class="nav-tab" title="' . esc_attr( $value['name'] ) . '" href="' . esc_attr( '#'.  $jquery_click_hook ) . '">' . esc_html( $value['name'] ) . '</a></li>';
		}
	}
...
function optionsframework_fields() {
	...
	foreach ( $hs_options as $value ) {
		...
		case 'typography':
			...
			unset( $font_size, $font_weight, $font_lineheight, $font_style, $font_face, $font_character, $font_color );
			...
			if ( $typography_options['lineheight'] ) {
				...
				$font_lineheight .= '<select class="of-typography of-typography-lineheight" name="'.$option_name.'['.$value['id'].'][lineheight]" id="'. $value['id'].'_lineheight">';
...
// Font Weight
			if ( $typography_options['weights'] ) {
				$font_weight = '<div class="field"><label for="of-typography-weight">Font Weight</label>';
			...
			$typography_fields = compact( 'font_size', 'font_lineheight', 'font_face', 'font_style', 'font_weight', 'font_character', 'font_color' );
		...
		case "heading":
			...
			$jquery_click_hook = preg_replace('/[^a-zA-Z0-9._\-]/', '', strtolower($value['name']) );
			$jquery_click_hook = "of-option-" . $jquery_click_hook;
			$hs_menu .= '<a id="'.  esc_attr( $jquery_click_hook ) . '-tab" class="nav-tab" title="' . esc_attr( $value['name'] ) . '" href="' . esc_attr( '#'.  $jquery_click_hook ) . '">' . esc_html( $value['name'] ) . '</a>';
